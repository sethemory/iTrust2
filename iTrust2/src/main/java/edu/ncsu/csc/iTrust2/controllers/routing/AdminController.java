...
public class AdminController {
    ...
    /**
     * Retrieves the manage patient advocates page
     *
     * @param model
     *            data for front end
     * @return mapping
     */
    @RequestMapping ( value = "admin/managePA" )
    @PreAuthorize ( "hasRole('ROLE_ADMIN')" )
    public String patientAdvocates ( final Model model ) {
        return "/admin/managePA";
    }

    /**
     * Retrieves the editPA page
     *
     * @param model
     *            data for front end
     * @return mapping
     */
    @RequestMapping ( value = "admin/editPA" )
    @PreAuthorize ( "hasRole('ROLE_ADMIN')" )
    public String editPAs ( final Model model ) {
        return "/admin/editPA";
    }

    /**
     * Retrieves the associate Patients page
     *
     * @param model
     *            data for front end
     * @return mapping
     */
    @RequestMapping ( value = "admin/associatePat" )
    @PreAuthorize ( "hasRole('ROLE_ADMIN')" )
    public String associatePatients ( final Model model ) {
        return "/admin/associatePat";
    }
}
