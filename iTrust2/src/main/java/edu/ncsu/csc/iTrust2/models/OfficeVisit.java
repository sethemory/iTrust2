...
public class OfficeVisit extends DomainObject {
    ...
    /**
     * This field is for holding the value of the patient advocate if they
     * attended their patients OV
     */
    private String               patientAdvocateAttended;
    ...
    /**
     * Returns the OfficeVisitForm's cptCodes
     *
     * @return the cptCodes
     */
    ...
    /**
     * Sets the OfficeVisitForm's cptCodes
     *
     * @param cptCodes
     *            the cptCodes to set
     */
    ...
    /**
     * This method gets the Patient Advocate that attended
     *
     * @return the Patient Advocate that attended
     */
    public String getPatientAdvocateAttended () {
        return patientAdvocateAttended;
    }

    /**
     * | This sets the Patient Advocate that attended
     *
     * @param patientAdvocateAttended
     *            the Patient Advocate that attended the Office visit
     */
    public void setPatientAdvocateAttended ( final String patientAdvocateAttended ) {
        this.patientAdvocateAttended = patientAdvocateAttended;
    }
