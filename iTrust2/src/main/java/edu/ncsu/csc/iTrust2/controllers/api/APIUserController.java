...
public class APIUserController extends APIController {
    ...
    private static final String       ROLE_PATIENT_ADVOCATE = "ROLE_PATIENT_ADVOCATE";

    /** All roles */
    private static final List<String> ALL_ROLES             = List.of( ROLE_ADMIN, ROLE_PATIENT, ROLE_HCP, ROLE_ER,
            ROLE_LABTECH, ROLE_VIROLOGIST, ROLE_OD, ROLE_OPH, ROLE_VACCINATOR, ROLE_BSM, ROLE_PATIENT_ADVOCATE );
    ...
    public ResponseEntity generateUsers () {
        ...
        final User advocate = new PatientAdvocate(
                new UserForm( "advocate", "123456", Role.ROLE_PATIENT_ADVOCATE, 1 ) );
